...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:00:00Z",
  "data": {
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:15:00Z",
  "data": {
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:20:00Z",
  "data": {
    "ai_result_id": "ai-001",
    "record_id": "rec-mri-001",
    "model_version": "brain_tumor_v3",
    "started_at": "2025-04-05T10:20:00Z"
  }
}
```
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:25:00Z",
  "data": {
    "ai_result_id": "ai-001",
    "record_id": "rec-mri-001",
    "model_version": "brain_tumor_v3",
    ...
    "confidence": 0.97,
    "completed_at": "2025-04-05T10:25:00Z"
  }
}
```
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:30:00Z",
  "data": {
    "diagnosis_id": "dx-001",
    "record_id": "rec-mri-001",
    "patient_id": "pat-abc123",
    ...
    "severity": "high",
    "confirmed_by": "doctor",
    "confirmed_at": "2025-04-05T10:30:00Z"
  }
}
```
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:35:00Z",
  "data": {
    "invoice_id": "inv-001",
    "patient_id": "pat-abc123",
    "amount": 350000,
    ...
    "status": "issued",
    "issued_at": "2025-04-05T10:35:00Z"
  }
}
```
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:40:00Z",
  "data": {
    "contract_id": "cr-001",
    "patient_id": "pat-abc123",
    ...
    "repayment_schedule": [
      { "month": 1, "due_date": "2025-05-05", "amount": 833333 },
      { "month": 2, "due_date": "2025-06-05", "amount": 833333 }
    ],
    "status": "active",
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:45:00Z",
  "data": {
    "payment_id": "pay-001",
    "invoice_id": "inv-001",
    "patient_id": "pat-abc123",
    ...
    "processed_at": "2025-04-05T10:45:00Z"
  }
}
```
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T10:50:00Z",
  "data": {
...
```json
{
  ...
  "version": "1.0",
  "occurred_at": "2025-04-05T11:00:00Z",
  "data": {
    ...
    "applied_at": "2025-04-05T11:00:00Z"
  }
}
```
